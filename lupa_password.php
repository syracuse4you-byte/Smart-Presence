...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['reset_request'])) {
    ...
    if (!empty($nis) && !empty($email) && filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        // Generate ID unik untuk request
...
<title>Lupa Password - SmartPresence</title>
...
<div class="bg-white w-full max-w-md p-8 rounded-[20px] shadow-[0_8px_30px_rgb(0,0,0,0.08)] z-10 mx-4">
    <div class="flex items-center mb-6">
        ...
        <h2 class="text-[20px] font-bold text-gray-900 ml-2">Pemulihan Akun</h2>
    </div>
    ...
    <div class="bg-green-50 border border-green-200 text-green-700 px-4 py-4 rounded-xl mb-6">
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-xs mt-1">Admin akan memproses permintaan Anda dalam 1x24 jam. Password baru akan dikirim ke email: <b><?= htmlspecialchars($email ?? '') ?></b></p>
    ...
    <div class="flex flex-col items-center justify-center mb-6">
        ...
        <h3 class="text-[18px] font-bold text-gray-900">Lupa Password?</h3>
        <p class="text-sm text-gray-500 mt-2 text-center leading-relaxed">
            Masukkan NIS dan email terdaftar Anda. Admin akan memproses permintaan dan mengirim password baru ke email Anda.
        </p>
    </div>

    <form action="" method="POST" class="space-y-4">
        <div>
            <label class="block text-sm font-semibold text-gray-700 mb-1.5">NIS (Nomor Induk Siswa)</label>
            <input type="text" name="nis" placeholder="Contoh: 22412/286.4.1" required
        ...
        <div>
            <label class="block text-sm font-semibold text-gray-700 mb-1.5">Email Terdaftar</label>
            <input type="email" name="email" placeholder="nama@email.com" required
                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
            <p class="text-[11px] text-gray-400 mt-1">* Password baru akan dikirim ke email ini</p>
        </div>
        <div class="bg-blue-50 border border-blue-100 rounded-xl p-3 flex gap-2.5">
            ...
            <p class="text-xs text-blue-700 leading-relaxed">
                Admin akan memverifikasi data Anda dan mengirim password baru dalam waktu <b>1x24 jam</b>.
            </p>
        </div>
    ...
    <p class="text-center text-sm font-medium text-gray-500 mt-6">
        Ingat password? <a href="login.php" class="text-blue-600 hover:text-blue-800 hover:underline font-semibold">Kembali ke Login</a>
    </p>
    <?php endif; ?>
</div>
</body>
